...
class GeneratorConfig
{
    ...
    public function loadPaths()
    {
        ...
        $this->pathRoutes = config('infyom.laravel_generator.path.routes', base_path('routes/web/web.php'));
        // JR: $this->pathRoutes = config('infyom.laravel_generator.path.routes', base_path('routes/web.php'));
