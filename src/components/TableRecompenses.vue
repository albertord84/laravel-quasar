      ...
      <q-table title=" "
        ...
        <template v-slot:top>
          ...
          <div class="col-4 text-center">
            <q-btn flat dense class="q-ml-lg" icon-right="navigate_before"  title="Página anterior" no-caps @click="getRecompenses(page-1)" :disable="page==0"/>
            ...
            <q-btn flat dense icon-right="navigate_next"  title="Página seguinte" no-caps @click="getRecompenses(page+1)" :disable="!hasMorePage"/>
          </div>
