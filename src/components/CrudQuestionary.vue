                    ...
                    <q-tab-panels v-model="tab" animated>
                      <q-tab-panel name="contentTab" class="q-pa-none">
                        ...
                        <div v-if="(selectedPageIndex>-1 || isCreatingNewPage)">
                            ...
                            <div v-if="[2, 3, 4].includes(questionary.pages[selectedPageIndex].type_id)" class="flex justify-between q-pt-sm">
  ...
  methods: {
    ...
    addResponseOption () {
      if (this.newResponseOption.response.trim() !== '') {
        this.responseOptions.push(Object.assign({}, this.newResponseOption))
