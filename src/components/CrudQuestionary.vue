  ...
  <div class="row justify-left">
    ...
    <div v-else class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-md-3 q-mt-lg justify-center">
              <q-list bordered>
                  ...
                  <div v-show="showPainelPageList">
                    <q-item v-for="(page,index) in questionaryModel.pages" clickable v-ripple v-bind:key="index" @click.prevent="showSelectedPage(index)">
          ...
          <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 col-md-6 q-mt-lg">
              <div v-if="questionaryModel.pages && questionaryModel.pages.length>0">
                              ...
                              <div v-if="(selectedPageIndex>-1 || isCreatingNewPage)">
                                  ...
                                  <div v-if="plane.code === 3">
                                    ...
                                    <div v-else class="flex justify-between q-pt-md">
                                      <b class="q-pt-md" v-if="questionaryModel.pages[selectedPageIndex].json_data.type === 'image'">Mídia: Imagen</b>
                                      <b class="q-pt-md" v-if="questionaryModel.pages[selectedPageIndex].json_data.type === 'video'">Mídia: Video</b>
                                      <div>
                                    ...
                                    <div class="q-pa-md bg-grey-3 q-mt-sm">
                                        <div class="q-col-gutter-md row items-start" >
                                            <div class="col-7 justify-center">
                                                <div v-if="questionaryModel.pages[selectedPageIndex].json_data === null || questionaryModel.pages[selectedPageIndex].json_data === ''"  style="padding-bottom:8rem">Nenhuma mídia adicionada</div>
                                                <q-img v-else-if="questionaryModel.pages[selectedPageIndex].json_data.type === 'image'"  :src="questionaryModel.pages[selectedPageIndex].json_data.src" :ratio="16/9"/>
                                                <q-video v-else-if="questionaryModel.pages[selectedPageIndex].json_data.type === 'video'" :ratio="16/9" src="https://www.youtube.com/embed/k3_tw44QsZQ?rel=0"/>
                                            </div>
                                        </div>
                                    </div>
                                  </div>
                                  ...
                                  <div v-if="[2, 3].includes(questionaryModel.pages[selectedPageIndex].response_type_id)" >
                                    ...
                                    <div class="flex justify-between q-col-8 q-pt-xs">
                                      ...
                                      <div v-if="questionaryModel.pages[selectedPageIndex].responseOptions.length === 0" class="q-pa-md bg-grey-3 q-mb-md" style="width:100%">
          ...
          <q-separator  class="col-12 q-pa-none q-ma-none"></q-separator>
          <div class="q-my-md">
            <q-btn text-color="white" class="q-pa-sm q-mb-sm bg-orange-8" label="Guardar questionário"  title="Guardar questionário" icon="save" @click.prevent="addQuestionary"/>
          </div>
    </div>
  </div>
</template>
